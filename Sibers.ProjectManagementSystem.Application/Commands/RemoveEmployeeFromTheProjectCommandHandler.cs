...
{
    public class RemoveEmployeeFromTheProjectCommandHandler : IRequestHandler<RemoveEmployeeFromTheProjectCommand, IResult>
    {
        ...
        public async Task<IResult> Handle(RemoveEmployeeFromTheProjectCommand request, CancellationToken cancellationToken)
        {
            try
            {
